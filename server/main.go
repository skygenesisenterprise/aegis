...
import (
	...
	"github.com/skygenesisenterprise/aegis/server/src/config"
	"github.com/skygenesisenterprise/aegis/server/src/interfaces"
	"github.com/skygenesisenterprise/aegis/server/src/routes"
	"github.com/skygenesisenterprise/aegis/server/src/services"
)
...
func displayBanner() {
	...
	fmt.Printf("\033[1;33m    ║                    AEGIS ENTERPRISE SERVER                   ║\n")
...
func main() {
	...
	fmt.Printf("\n")
	fmt.Printf("\033[1;36m┌─────────────────────────────────────────────────────────────────┐\n")
	fmt.Printf("\033[1;36m│                    🚀 AEGIS ENTERPRISE SERVER READY              │\n")
	fmt.Printf("\033[1;36m├─────────────────────────────────────────────────────────────────┤\n")
